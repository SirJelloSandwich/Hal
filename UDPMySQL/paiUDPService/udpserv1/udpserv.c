...
void _INIT udpservINIT(void)
{
	...
	//udp server init	
	udpServerInit(&gUdpServerMySQL);

	//application specific udp server init	
	gUdpServerMySQL.serverIf.iEnable = 1;

	gUdpServerMySQL.serverIf.iUdpServerPort = gUdpServerMySQL_DefaultPort;
}
...
void _CYCLIC udpservCYCLIC(void)
{
	...
	//udp server cyclic
	udpServerCyclic(&gUdpServerMySQL);
}
